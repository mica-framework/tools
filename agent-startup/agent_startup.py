...
def _startup_agent():
    ...
    try:
        p = subprocess.Popen('powershell Invoke-Command -ScriptBlock {Start-Process "C:\\\'Program Files\'\\MiCA-Framework\\mica-agent.exe" --backend http://192.168.123.101/}', shell=True)
        p.wait()
